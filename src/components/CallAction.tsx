...
const CallAction = () => {
  return (
    <section className="bg-[#1F0B0B] mt-[150px]">
      <div className="max-w-[1240px] w-full h-full m-auto px-[16px] sm:[25px] md:px-[50px] xl:px-0">
        <div className="flex justify-center items-center gap-[200px] w-full py-[70px]">
          <div className="flex flex-col max-w-[400px] w-full">
            ...
            <input
              ...
              text-[#EEE] font-outfit text-base font-normal outline-none"
            />
            ...
            <button className="mt-[32px] py-5 text-center text-[#1F0B0B] font-outfit text-[20px] font-semibold 
            leading-[100%] bg-[#FFBE42] rounded-[20px] border-2 border-solid border-transparent 
          ...
          <h2 className="flex flex-col gap-5 text-[#EEE]">
            <div className="font-outfit leading-[100%] text-[96px]">
